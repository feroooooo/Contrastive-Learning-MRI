...
if __name__ == "__main__":
    ...
    if args['data_type'] == 'all' or args['data_type'] == 'single':
        ...
        dataset = ADNIDataset(data_dir=args['data_dir'], csv_path=csv_path, transform=pre_transform)
        # 数据集大小
    ...
    # 提取分割的数据集，每个被试只存在于一个集合
        ...
        train_dataset = ADNIDataset(data_dir=args['data_dir'], csv_path="E:/Data/ADNI/train label.csv", transform=pre_transform)
        ...
        train_dataset = ADNIDataset(data_dir=args['data_dir'], csv_path="E:/Data/ADNI/single_train.csv", transform=pre_transform)
