...
class Predictor:
    def __init__(self) -> None:
        ...
        # self.model_classification = self.load_model_classification(self.model_classification, r"E:\Code\github\Contrastive-Learning-MRI\runs\resnet_classification_finish\checkpoint_last.pth")
        self.model_classification = self.load_model_classification(self.model_classification, r"E:\Code\github\Contrastive-Learning-MRI\runs\simclr_resnet_100\linear_checkpoint_0100.pth_aug\checkpoint_last.pth")
        # self.model_classification = self.load_model_classification(self.model_classification, r"E:\Code\github\Contrastive-Learning-MRI\runs\simclr_resnet_100\finetune_checkpoint_0100.pth_aug\checkpoint_last.pth")
